...
// End Chức năng HỦY Từ chối kết bạn
                        ...
                        <div class="box-user">
                          ...
                          <div class="inner-info">
                            ...
                            <div class="inner-buttons">
                              <button class="btn btn-sm btn-primary m-1" btn-accept-friend="${data.infoUserA._id}">Chấp nhận</button>
                              <button class="btn btn-sm btn-secondary m-1" btn-refuse-friend="${data.infoUserA._id}">Xóa</button>
                              <button class="btn btn-sm btn-secondary m-1" btn-deleted-friend disabled>Đã xóa</button>
                              <button class="btn btn-sm btn-primary m-1" btn-accepted-friend disabled>Đã chấp nhận</button>
                            </div>
                          </div>
                        </div>
                      `;
